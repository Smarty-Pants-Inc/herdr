...
/// Best-effort PID attribution for a connected local socket peer.
///
/// Non-Unix and unsupported Unix transports intentionally return `None` so
/// callers retain their normal compatibility path when attribution is absent.
#[cfg(unix)]
